...
return {
    get: (data, callback) =>{
        ...
        if(data.query && typeof data.query.nombre !== "undefined" || data.query.tipo !== "undefined" || data.query.propietario !== "undefined"){
            const llavesQuery = Object.keys(data.query);
            let respuestaMascotas = [...mascotas];
            for(const llave of llavesQuery){
                respuestaMascotas.filter((_mascota)=>_mascota[llave] === data.query[llave]);
            }
